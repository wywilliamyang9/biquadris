...
void JBlock::CWRotate(Board & playerBoard) {
    if (state == 1) {
        ...
        if (playerBoard.getBoard().at(i1.coord.row-2).at(i1.coord.col).
        getColour() != Colour::White) canRotate = 0;
        if (!canRotate) return;
        ...
        playerBoard.getBoard().at(i1.coord.row-2).at(i1.coord.col).
        setColour(i1.colour); 
        ...
        getColour() != Colour::White) canRotate = 0;
        if (playerBoard.getBoard().at(i1.coord.row+1).at(i1.coord.col+2).
        getColour() != Colour::White) canRotate = 0;
        ...
        playerBoard.getBoard().at(i1.coord.row+1).at(i1.coord.col+2).
        setColour(i1.colour); 
        cells.at(1)->setColour(Colour::White);
        ...
        getColour() != Colour::White) canRotate = 0;
        if (playerBoard.getBoard().at(i3.coord.row+2).at(i3.coord.col+1).
        getColour() != Colour::White) canRotate = 0;
        if (!canRotate) return;
...
void JBlock::CounterCWRotate(Board &playerBoard) {
    if (state == 1) {
        Info i3 = cells.at(3)->getinfo();
        Info i2 = cells.at(2)->getinfo();
        Info i1 = cells.at(1)->getinfo();
        ...
        getColour() != Colour::White) canRotate = 0;
        if (playerBoard.getBoard().at(i3.coord.row).at(i3.coord.col+2).
        getColour() != Colour::White) canRotate = 0;
        if (!canRotate) return;
